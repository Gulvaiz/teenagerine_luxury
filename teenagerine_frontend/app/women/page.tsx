...
export default async function WomenPage({ searchParams }: { searchParams: Promise<{ [key: string]: string }> }) {
    const resolvedSearchParams = await searchParams;
    // Merge category param with any other search params (price, brand, etc.)
    const params = { ...resolvedSearchParams, category: 'women' };
        ...
        <>
            ...
            <main className="container" style={{ padding: '40px 20px' }}>
                <div style={{ marginBottom: '20px', fontSize: '0.9rem', color: '#666' }}>
                    <Link href="/">Home</Link> / <span>Women</span>
                </div>
